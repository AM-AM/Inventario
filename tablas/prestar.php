<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Préstamo de artículo</h1>
          

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Seleccione el artículo a solicitar.</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table " id="dataTable" width="100%" cellspacing="0">
                  ...
                  <form>
                    ...
                    <tr>
                      <td>Hora final</td>
                      <td><input type="time" class="form-control" name="fecha-fin"> </td>
                    </tr>
                    <tr>
                      <td>Artículo</td>
                      <td>
